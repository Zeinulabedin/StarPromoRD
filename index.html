         ...
         <header class="top-header">
            <div class="container">
               <div class="row">
                  <div class="col-sm-6">
                     <div class="logo_main">
                        <a href="index.html"><img src="images/star_promo_rd_logo_1.png" /></a>
                     </div>
                  </div>
                  <div class="col-sm-6">
                           ...
                           <div class="row">
                              <div class="col-md-12">
                                 <div class="slide_text">
                                    <h6>Promocionando Historias</h6>
                                    <h4>Community Managers</h4>
                                    <h5>Todo Tipo de Promociones</h5>
                                    <br>
                                    <a class="readmore_bt" href="about.html">Leer Más</a>
                                 </div>
                              </div>
                           </div>
                        </div>
                     ...
                     <div class="pogoSlider-slide" style="background-image:url(images/slider_2.jpg);">
                        <div class="container">
                           <div class="row">
                              <div class="col-md-12">
                                 <div class="slide_text">
                                    <h6>Creando Historias</h6>
                                    <h4>Organizando Eventos</h4>
                                    <h5>Bodas, Cumpleaños, Conciertos y más</h5>
                                    <br>
                     ...
                     <div class="pogoSlider-slide" style="background-image:url(images/slider_3.jpg);">
                        <div class="container">
                           <div class="row">
                              <div class="col-md-12">
                                 <div class="slide_text">
                                    <h6>Te ponemos en el mapa</h6>
                                    <h4>Desarrolladores Web</h4>
                                    <h5>Creación y Mantenimiento de Páginas Web</h5>
                                    <br>
                                    <a class="readmore_bt" href="about.html">Read More</a>
                                 </div>
                              </div>
            ...
            <div class="container">
               <div class="row">
                  <div class="col-md-12">
                     <div class="full">
                        <div class="heading_main text_align_center">
                           <h2 class="margin-bottom_30"><strong class="small theme_color">Incrementa tus clientes por</strong><br>Un mejor posicionamiento de tú Negocio</h2>
                        </div>
                     </div>
                  </div>
               </div>
               <div class="row">
                <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
                     <div class="full">
                        ...
                        <p>Hay muchas variaciones de pasajes de Lorem Ipsum disponibles, pero la mayoría han sufrido alteraciones de alguna forma, por humor inyectado o palabras aleatorias que no parecen ni un poco creíbles. Si vas a usar un pase<br><br>edad de Lorem Ipsum, debe asegurarse de que no hay muchas variaciones de pasajes de Lorem Ipsum disponibles, pero la mayoría ha sufrido alteraciones de alguna forma, por humor inyectado o palabras aleatorias que no parecen ni un poco creíbles. Si va a utilizar un pasaje de Lorem Ipsum, debe asegurarse de que no haya</p>
                      </div>
                  ...
                  <div class="col-md-12">
                     <div class="full">
                        <div class="heading_main text_align_center margin-bottom_30">
                           <h2><strong class="small theme_color">Proyectos Anteriores</strong><br>Nuestros estudios de caso</h2>
                        </div>
                     </div>
                  </div>
                  <div class="col-lg-10 offset-lg-1">
                     <div class="full text_align_center">
                         <p>Hay muchas variaciones de pasajes de Lorem Ipsum disponibles, pero la mayoría ha sufrido alteraciones en algunos 
                          forma, con humor inyectado, o palabras aleatorias que no parecen ni un poco creíbles. Si va a utilizar un 
                          Paso de Lorem Ipsum, debes estar segura de que no hay</p>
                     </div>
                  </div>
               </div>
               <div class="row">
                  ...
                  <div class="col-md-12 col-lg-4">
                     <div class="full">
                        <div class="heading_main text_align_left" style="margin-bottom: 0;">
                           <h2><strong class="small">Obtenga su cotización gratis</strong><br>Hoy</h2>
                        </div>
                     </div>
                  </div>
            ...
            <div class="container">
               <div class="row">
                  <div class="col-md-12">
                     <div class="full">
                        <div class="heading_main text_align_center margin-bottom_30">
                           <h2><strong class="small theme_color">Hemos trabajado mucho, vamos</strong><br>Mira algunos de aquí</h2>
                        </div>
                     </div>
                  </div>
               </div>
               ...
               <div class="row">
                  ...
                  <div class="col-lg-3 col-md-6 col-sm-6 white_fonts">
                     <div class="full footer_blog f_icon_2">
                        <p>Teléfono<br><small>+84 126 922 0162<br>+84 905 333 333<br>Lunes - Domingo<br>08:00 am - 05:00 pm</small></p>
                     </div>
                  </div>

                  <div class="col-lg-3 col-md-6 col-sm-6 white_fonts">
                     <div class="full footer_blog f_icon_3">
                         <p>Email<br><small>support@sofbox.com<br>Soporte online 24 X 7</small></p>
                     </div>
                  </div>
